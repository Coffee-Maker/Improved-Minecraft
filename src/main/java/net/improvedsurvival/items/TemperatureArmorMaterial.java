...
public enum TemperatureArmorMaterial implements ArmorMaterial {
    ...
    private TemperatureArmorMaterial(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantability, SoundEvent equipSound, float toughness, Supplier<Ingredient> ingredientSupplier, float temperature, float heatRetention, float coldRetention) {
    this.name = name;
