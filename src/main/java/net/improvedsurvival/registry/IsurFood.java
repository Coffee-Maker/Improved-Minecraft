...
public class IsurFood {
	...
	public static void registerFoods() {
		...
		Registry.register(
				Registry.ITEM, new Identifier(Isur.MODID, "sweet_berry_jam_bottle"),
				new BottledFood(new Item.Settings().group(Isur.ISUR).food(SWEET_BERRY_JAM_BOTTLE).recipeRemainder(Items.GLASS_BOTTLE).maxCount(16), true)
		);
		Registry.register(
				Registry.ITEM, new Identifier(Isur.MODID, "frost_berry_jam_bottle"),
				new BottledFood(new Item.Settings().group(Isur.ISUR).food(FROST_BERRY_JAM_BOTTLE).recipeRemainder(Items.GLASS_BOTTLE).maxCount(16), true)
		);
